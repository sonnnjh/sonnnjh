...
<html>
	...
	<body>
		<div id="table">
			<form action="modSave" method="get">
				<table>
					<td hidden>번호</td>
					<input type="hidden" name="num" value=${modvo.num} readonly></td>
					<tr>
						<td>식당명</td>
					...
					<tr>
						<td>음식 종류</td>
						<td><input type="text" name="category" value=${modvo.category }></td>
					</tr>
					<tr>
						<td>위치</td>
						<td><input type="text" name="place" value=${modvo.place }></td>
					</tr>
					<tr>
						<td>대표메뉴</td>
						<td><input type="text" name="bestMenu" value=${modvo.bestMenu }></td>
					</tr>
						<td>가격</td>
						<td><input type="text" name="price" value=${modvo.price }></td>
					<tr>
